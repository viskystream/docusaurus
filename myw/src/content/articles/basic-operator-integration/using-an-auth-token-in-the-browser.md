...
| `streamName`     | string   | The name of the stream that you will be creating with the Encoder, **it is extremely important that this matches the  {% definition-hover path="streamname" %}streamName{% /definition-hover %} prop passed to the Encoder, otherwise, your broadcast will not work.**                                                                                                                                                           |
